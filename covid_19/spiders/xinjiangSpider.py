...
class XinjiangSpider(Spider):
    def __init__(self):
        super(XinjiangSpider, self).__init__()
        self.num = 1
    name = "xinjiang"
    original_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/xinjiang/"
    def start_requests(self):
        url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/xinjiang/index.htm"
    ...
    def parse(self,response):
        ...
        if self.num < 3:
            next_page_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/xinjiang/index_%s.htm"%str(self.num)
            self.num += 1
