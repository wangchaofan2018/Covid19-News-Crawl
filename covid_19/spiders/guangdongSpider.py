...
class GuangdongSpider(Spider):
    def __init__(self):
        super(GuangdongSpider, self).__init__()
        self.num = 1
    name = "guangdong"
    original_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/guangdong/"
    def start_requests(self):
        url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/guangdong/index.htm"
    ...
    def parse(self,response):
        ...
        if self.num < 4:
            next_page_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/guangdong/index_%s.htm"%str(self.num)
            self.num += 1
