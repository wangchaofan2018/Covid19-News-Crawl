...
class ShanghaiSpider(Spider):
    def __init__(self):
        ...
        self.num = 1
    name = "shanghai"
    original_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/shanghai/"
    def start_requests(self):
        url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/shanghai/index.htm"
    ...
    def parse(self,response):
        ...
        if self.num < 5:
            next_page_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/shanghai/index_%s.htm"%str(self.num)
            self.num += 1
