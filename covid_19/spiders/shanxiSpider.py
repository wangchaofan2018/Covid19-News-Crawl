...
class ShanxiSpider(Spider):
    ...
    #             if i > 0:
    #                 next_url = self.base_url + "/index_"+i+".shtml"
    #                 yield scrapy.Request(url=next_url,meta={'use_browser':True},callback=self.list_parse,dont_filter=True)
    #             else:
    #                 yield scrapy.Request(url="http://www.shanxi.gov.cn/yw/xwfbh/szfxwfbh/index.shtml",meta={'use_browser':True},callback=self.list_parse,dont_filter=True)
    ...
    def list_parse(self,response):
        ...
        if total_page_obj:
            ...
            if self.since<total_page:
                next_url = self.base_url + "/index_"+self.since+".shtml"
    ...
    def detail_parse(self,response):
        ...
        summary = sel.xpath('//p[@align="center"]/following-sibling::p[1]/text()').extract_first().strip()
        content = ""
