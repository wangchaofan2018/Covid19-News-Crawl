...
class HainanSpider(Spider):
    def __init__(self):
        ...
        self.num = 1
    name = "hainan"
    original_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/hainan/"
    def start_requests(self):
        url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/hainan/index.htm"
    ...
    def parse(self,response):
        ...
        if self.num < 3:
            next_page_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/hainan/index_%s.htm"%str(self.num)
            self.num += 1
