...
class JiangxiSpider(Spider):
    def __init__(self):
        super(JiangxiSpider, self).__init__()
        self.num = 1
    name = "jiangxi"
    original_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/jiangxi/"
    def start_requests(self):
        url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/jiangxi/index.htm"
    ...
    def parse(self,response):
        ...
        if self.num < 4:
            next_page_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/jiangxi/index_%s.htm"%str(self.num)
            self.num += 1
