...
class ChongqingSpider(Spider):
    def __init__(self):
        super(ChongqingSpider, self).__init__()
        self.num = 1
    name = "chongqing"
    original_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/chongqing/"
    def start_requests(self):
        url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/chongqing/index.htm"
    ...
    def parse(self,response):
        ...
        if self.num < 6:
            next_page_url = "http://www.scio.gov.cn/xwfbh/gssxwfbh/xwfbh/chongqing/index_%s.htm"%str(self.num)
            self.num += 1
